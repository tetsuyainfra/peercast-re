...
impl PingBuilder2 {
    ...
    pub fn build(self) -> Vec<AtomMut> {
        let magic_atom = AtomMut::from((Id4::PCP_CONNECT, 1_u32));
        ...
        vec![magic_atom.into(), ping_atom.into()]
    }
}
